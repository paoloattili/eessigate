...
export class VisualizzaContenutiGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad {
  ...
  constructor(
    ...
    console.warn('Sono in VisualizzaContenutiGuard');
  }
