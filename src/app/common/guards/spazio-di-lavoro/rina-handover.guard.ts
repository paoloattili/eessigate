...
export class RinaHandoverGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad {
  ...
  constructor(
    ...
    console.warn('Sono in template-nuovo-workspace');
  }
