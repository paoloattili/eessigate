...
export class AccountingDeliverablesGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad {
  ...
  constructor(
    ...
    console.warn('AccountingDeliverablesGuard');
  }
